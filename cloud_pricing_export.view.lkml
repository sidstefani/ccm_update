...
view: pricing {
  ...
  derived_table: {
    ...
    explore_source: cloud_pricing_export {
      ...
      column: pricing_unit {}
      column: pricing_type {}
      column: pricing_product_taxonomy_str {}
      column: category {}
...
view: cloud_pricing_export {
  ...
  dimension: category {
    type: string
    sql:  CASE WHEN ${product_taxonomy}[SAFE_OFFSET(1)] IS NULL
            AND REGEXP_CONTAINS(${sku__description}, r'operations') AND ${service__description} = 'Cloud Storage' THEN 'Storage'
            ELSE ${product_taxonomy}[SAFE_OFFSET(1)] END ;;
  }
          ...
          WHEN ${service__description} = 'Cloud Storage'
            THEN(
              CASE
                ...
                WHEN REGEXP_CONTAINS(${pricing_product_taxonomy_str}, r'dual region->standard')
                  THEN 'Dual-Region Standard'
                WHEN
                ...
                WHEN REGEXP_CONTAINS(${pricing_product_taxonomy_str}, r'archive') AND REGEXP_CONTAINS(${sku__description}, r'multi-region')  THEN 'Archive Mutli-Regional'
                ...
                WHEN REGEXP_CONTAINS(${sku__description}, r'coldline') THEN 'Coldline'
                WHEN REGEXP_CONTAINS(${sku__description}, r'archive') AND REGEXP_CONTAINS(${sku__description}, r'multi-region')  THEN 'Archive Mutli-Regional'
                WHEN REGEXP_CONTAINS(${sku__description}, r'archive') THEN 'Archive'
                WHEN REGEXP_CONTAINS(${pricing_product_taxonomy_str}, r'dual-region') THEN 'Dual-Region Standard'
                WHEN REGEXP_CONTAINS(${pricing_product_taxonomy_str}, r'ingress') THEN 'Ingress Network'
                WHEN REGEXP_CONTAINS(${pricing_product_taxonomy_str}, r'egress') THEN 'Egress Network'
                WHEN REGEXP_CONTAINS(${pricing_product_taxonomy_str}, r'autoclass') THEN 'Autoclass'
                WHEN REGEXP_CONTAINS(${sku__description}, r'dual-region standard class') THEN 'Dual-Region Standard'
                -- fallback
                ELSE '_PARSE_ERROR'
                END
            )
  ...
  dimension: pricing_category {
    sql: CASE
          ...
          WHEN ${service__description} = 'Compute Engine' and  REGEXP_CONTAINS(${pricing_product_taxonomy_str}, r'licenses') THEN 'Licenses'
          WHEN ${service__description} = 'Compute Engine' and  REGEXP_CONTAINS(${sku__description}, r'snapshot') THEN 'Snapshot'
          ...
          WHEN ${service__description} = 'Cloud Storage' and ${category} = 'Storage'
            THEN(
              CASE
                ...
                WHEN REGEXP_CONTAINS(${sku__description}, r'operations') THEN 'Operations'
                -- fallback
                ELSE 'Data Storage'
                END
            )
